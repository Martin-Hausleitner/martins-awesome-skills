...
| Software craft | `test-driven-development`, `systematic-debugging` | Better implementation loops and root-cause debugging |
| GitHub | `github-code-review` | Structured review of local diffs and pull requests |
| Creative tools | `ascii-art` | Lightweight visual output and terminal-friendly art |
| Research | `arxiv`, `youtube-content` | Paper search and video-content workflows |
